...
class Startup extends AbstractModule {
  ...
  var allFilms = Seq(
    ...
    ,Film(2,"The Secret Life Of Pets","U","Max (Louis C.K.) is a spoiled terrier who enjoys a comfortable life" +
    ...
    ,Film(3,"Wonder Woman 1984","12A","Diana Prince lives quietly among mortals in the vibrant, sleek 1980s -- " +
    ...
    ,Film(4,"Jumanji: The Next Level","12A","When Spencer goes missing, the gang returns to Jumanji to travel unexplored " +
    ...
    ,Film(5,"Spectre","12A","James Bond receives an obscure message from M about a sinister organisation, 'SPECTRE'. " +
    ...
    ,Film(6,"Maze Runner: The Scorch Trials","12A","Upon escaping the maze, Thomas and his friends are shifted to a facility run " +
    ...
    ,Film(7,"The Lion King","PG","Simba, a young lion prince, flees his kingdom after the murder of his father, Mufasa. " +
    ...
    ,Film(8,"Star Wars: The Rise of Skywalker (Episode IX)","12A","The revival of Emperor Palpatine resurrects the battle between " +
